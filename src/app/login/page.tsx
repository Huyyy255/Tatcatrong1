    ...
    return (
        <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] bg-background/95 px-4">
            <div className="login-card-container">
                <div className="relative z-20 bg-card p-8 rounded-lg shadow-2xl space-y-6 border border-border">
                    ...
                    <div className="flex justify-between items-center text-sm">
                        <Link href="#" className="font-medium text-muted-foreground hover:text-cyan-400">
                            Forgot Password?
                        </Link>
